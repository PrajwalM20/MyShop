            ...
            <div className="card" style={{ display:'flex', gap:'32px', alignItems:'center', flexWrap:'wrap', padding:'32px' }}>
              {about.ownerImageUrl && (
                <div style={{ flexShrink:0 }}>
                  <img src={about.ownerImageUrl} alt={about.ownerName} draggable={false} onContextMenu={e => e.preventDefault()} style={{ width:'120px', height:'120px', borderRadius:'50%', objectFit:'cover', border:'3px solid var(--gold)', boxShadow:'0 0 30px rgba(212,175,55,0.2)', pointerEvents:'none', WebkitUserDrag:'none' }} />
                </div>
              )}
              <div style={{ flex:1 }}>
